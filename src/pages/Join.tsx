...
const Join = () => {
	...
	const handleSubmit = (e:React.FormEvent) => {
		...
		Axios.get("https://licenta-986d3-default-rtdb.europe-west1.firebasedatabase.app/teams.json").then((response)=>{
			...
			notEnrolled && newData?.privacy === "Private" && Axios.put(`https://licenta-986d3-default-rtdb.europe-west1.firebasedatabase.app/teams/${newData.key}.json`,{
					...newData, requests:[...response.data[newData.key].requests,{id:1234}]
				})
			
			notEnrolled && newData?.privacy === "Public" && Axios.put(`https://licenta-986d3-default-rtdb.europe-west1.firebasedatabase.app/teams/${newData.key}.json`,{
					...newData, members:[...response.data[newData.key].members,{id:1234}]
				})
